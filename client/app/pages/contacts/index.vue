<template>
  ...
  >
    ...
    >
      <u-icon
        :name="item.icon"
        class="text-blue-600 dark:text-blue-200 text-2xl mb-2"
      />
      <h3 class="font-semibold text-gray-700 dark:text-white text-lg mb-1">
        {{ item.title }}
      </h3>
      <p class="text-gray-600 dark:text-gray-200">{{ item.text }}</p>
    </div>
  </section>
